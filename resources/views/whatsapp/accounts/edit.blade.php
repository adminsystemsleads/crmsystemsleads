      ...
      <div class="bg-white shadow-sm sm:rounded-lg p-6">
        ...
        <form method="POST" action="{{ route('whatsapp.accounts.update', $account) }}">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div>
              <div class="flex items-center justify-between gap-2 mb-1 h-7">
                <label class="block text-sm font-medium text-gray-700">WABA ID *</label>
                <button type="button" id="autoDetectWaba"
                        class="text-xs text-indigo-600 hover:text-indigo-800 font-medium inline-flex items-center gap-1 whitespace-nowrap shrink-0">
            ...
            <div>
              <div class="flex items-center mb-1 h-7">
