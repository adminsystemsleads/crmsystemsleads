...
<div class="flex flex-col bg-white" style="height:100vh;height:100dvh;">
  ...
  <div id="leftPanel" class="shrink-0 border-r border-gray-200">
    ...
    <div class="px-3 py-2 border-b border-gray-100 bg-white space-y-2" id="sidebarFilters"
      ...
      <div class="relative">
        <svg class="absolute size-4 text-gray-400" style="left: 10px; top: 50%; transform: translateY(-50%);" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <button type="button" id="sidebarSearchClear"
                class="hidden absolute text-gray-400 hover:text-red-500 p-0.5"
