<div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 px-4"
    ...
    <div class="w-full sm:max-w-md mt-6 bg-white shadow-2xl overflow-hidden"
         style="border-top: 4px solid #C9A961; border-radius: 14px;">
        <div style="padding: 2.5rem 2.5rem 2.25rem 2.5rem;">
            {{ $slot }}
        </div>
    </div>
    ...
    <p class="mt-6 text-xs" style="color: rgba(255,255,255,.55);">
        &copy; {{ date('Y') }} Desarrollado por Systems Leads
    </p>
</div>
