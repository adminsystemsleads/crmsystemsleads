...
<div x-data>
      ...
      <div class="px-3 py-2 border-t border-gray-100 shrink-0 relative"
        ...
        @if ($isAdmin && !$licenseBlocked)
          <div class="relative mt-1">
            ...
            {{-- Drop-up del menú de Configuración --}}
            <div x-show="openCfg"
                 x-transition:enter="transition ease-out duration-150"
                 x-transition:enter-start="opacity-0"
                 x-transition:enter-end="opacity-100"
  ...
  <button x-show="!$store.sidebar.open"
          ...
          class="fixed top-4 left-4 z-30 p-1.5 sm:p-2 bg-white text-gray-700 rounded-lg border border-gray-300 shadow-md hover:bg-gray-50 transition"
