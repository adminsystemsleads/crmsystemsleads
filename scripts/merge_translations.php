...
$TRANSLATIONS = [
    ...
    'Muestra de contenido multimedia' => ['Media sample', 'Amostra de mídia'],
    'Opcional'                    => ['Optional', 'Opcional'],
    'Imagen'                      => ['Image', 'Imagem'],
    'Vídeo'                       => ['Video', 'Vídeo'],
    'Documento'                   => ['Document', 'Documento'],
    'Ubicación'                   => ['Location', 'Localização'],
    'Título (encabezado de texto)' => ['Title (text header)', 'Título (cabeçalho de texto)'],
    'Bloqueado: el encabezado es multimedia' => ['Locked: the header is media', 'Bloqueado: o cabeçalho é mídia'],
    'Botones'                     => ['Buttons', 'Botões'],
    'Opcional, hasta 3'           => ['Optional, up to 3', 'Opcional, até 3'],
    'Respuesta rápida'            => ['Quick reply', 'Resposta rápida'],
    'Enlace (URL)'                => ['Link (URL)', 'Link (URL)'],
    'Teléfono'                    => ['Phone', 'Telefone'],
    'Quitar'                      => ['Remove', 'Remover'],
    'Texto del botón'             => ['Button text', 'Texto do botão'],
    'Añadir botón'                => ['Add button', 'Adicionar botão'],
    'Ir al sitio web (enlace)'    => ['Visit website (link)', 'Ir ao site (link)'],
    'Llamar al número de teléfono' => ['Call phone number', 'Ligar para o número'],
];
